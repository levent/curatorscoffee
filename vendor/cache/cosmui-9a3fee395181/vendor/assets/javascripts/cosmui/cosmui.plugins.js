 ...
 * PLUGINS
 * 
 * - Google Code Pretify  -  http://code.google.com/p/google-code-prettify/ 
...
(function( $ ){ $.timeago.settings.allowFuture = true; $("time.timeago").timeago(); })(window.jQuery);
...
(function($) {
    ...
    Tipsy.prototype = {
        show: function() {
            ...
            if (title && this.enabled) {
                ...
                if (this.options.fade) {
                    $tip.stop().css({opacity: 0, display: 'block', visibility: 'visible'}).animate({opacity: this.options.opacity},cosmUI.settings.animation.fast);
                } else {
        ...
        hide: function() {
            if (this.options.fade) {
                this.tip().stop().fadeOut(cosmUI.settings.animation.fast, function() { $(this).remove(); });
            } else {
                this.tip().remove();
            }
        },
...
if (window.cosmUI) {  
  ...
  // Definition
  //
  // This cosmUI plugin is a middleware for Tipsy
  //
   
  cosmUI.tooltip = (function( $ ){
    "use strict"
    
    // ----------------------------------- 
    // Private
    
    var globalSelector = '[data-cosmui*="tooltip"]',
        ...
        init = function ( e ) {
          ...
          $(globalSelector).tipsy({
            gravity : function () { return $(this).attr('data-gravity') || 's' },
            delayIn : 250,
            opacity : 1,
            fade    : false,
            offset  : 3    
          ...
          if ($('.datastream-graph-empty').length) {
            $('.datastream-graph-value.editable[data-cosmui*="tooltip"]').tipsy("show");
          }
